        ...
        >
          ...
          >
            ...
            <select
              ...
              onChange={(e) =>
                selectModel(
                  availableModels.find((m) => m.id === e.target.value)
                )
              }
          ...
          {/* Messages area */}
          <div
            className={`flex-1 overflow-y-auto p-4 space-y-4 h-[calc(32rem-8rem)] 
          ...
          >
                  ...
                  {message.availableSlots &&
                    ...
                    message.followUp && (
                      <div className="mt-3 space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {message.availableSlots.map((slot) => (
                            <button
                              ...
                              disabled={loading}
                              onClick={() =>
                                handleSelectSlot(slot.index - 1, slot)
                              }
                        ...
                        >
                          Click a slot or type number / time (e.g. 14:30) or
                          'cancel'
                        </div>
                      </div>
                    )}
            ...
            {loading && (
              <div className="flex justify-start">
                <div
                  className={`rounded-xl p-3 flex items-center space-x-1
